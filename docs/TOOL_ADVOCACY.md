...
| Phase 2 | partial — 11 of 16 sites landed (substrate_purity / link_check / label_consistency / contrast / csp / a11y_landmarks / sri / id_strategy / html_semantic / external_assets / asset_optimization) | Refactor remaining 5 ◐ emission sites (one PR per phase, low blast radius each) |
