...
| Phase 2 | partial — 6 of 16 sites landed (substrate_purity / link_check / label_consistency / contrast / csp / a11y_landmarks) | Refactor remaining 10 ◐ emission sites (one PR per phase, low blast radius each) |
