...
| Phase 2 | partial — 4 of 16 sites landed (substrate_purity / link_check / label_consistency / contrast) | Refactor remaining 12 ◐ emission sites (one PR per phase, low blast radius each) |
