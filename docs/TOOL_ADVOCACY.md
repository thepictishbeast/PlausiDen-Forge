...
| Phase 2 | partial — 9 of 16 sites landed (substrate_purity / link_check / label_consistency / contrast / csp / a11y_landmarks / sri / id_strategy / html_semantic) | Refactor remaining 7 ◐ emission sites (one PR per phase, low blast radius each) |
