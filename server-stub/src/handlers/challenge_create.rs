//! `challenge-create` — backend handler stub.
//!
//! Method: POST
//! Path:   /challenges/new
...
/// `challenge-create` request payload.
...
/// `challenge-create` response payload.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct Response {
...
pub async fn handle_post(_req: Request) -> Result<Response, anyhow::Error> {
    // TODO: implement challenge-create (user opens the challenge-creation flow from the feed-top composer).
    Ok(Response { ok: true })
}
...
mod tests {
    ...
    fn module_name_matches_key() {
        // Self-doc: this file lives at src/handlers/challenge_create.rs
        // for backend key "challenge-create".
        assert_eq!("challenge_create", "challenge_create");
    }
}
