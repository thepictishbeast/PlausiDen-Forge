...
pub async fn handle_post(_req: Request) -> Result<Response, anyhow::Error> {
    // TODO: implement sign-in (operator sign-in).
    Ok(Response { ok: true })
}
...
mod tests {
    ...
    fn module_name_matches_key() {
        // Self-doc: this file lives at src/handlers/sign_in.rs
        // for backend key "sign-in".
        assert_eq!("sign_in", "sign_in");
    }
}
